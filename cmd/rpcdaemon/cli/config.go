...
import (
	...
	"github.com/jeromelaurens/erigon/cmd/rpcdaemon/health"
...
func RootCommand() (*cobra.Command, *httpcfg.HttpCfg) {
	...
	rootCmd.PersistentFlags().StringSliceVar(&cfg.API, "http.api", []string{"eth", "erigon"}, "API's offered over the HTTP-RPC interface: eth,erigon,web3,net,debug,trace,txpool,db. Supported methods: https://github.com/jeromelaurens/erigon/tree/devel/cmd/rpcdaemon")
